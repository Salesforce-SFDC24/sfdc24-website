...
const decomposeCustomLabelsBeta = __importStar(require("./decomposeCustomLabelsBeta.json"));
const decomposeCustomLabelsBeta2 = __importStar(require("./decomposeCustomLabelsBeta2.json"));
const decomposePermissionSetBeta = __importStar(require("./decomposePermissionSetBeta.json"));
...
exports.presetMap = new Map([
    ...
    ['decomposePermissionSetBeta', decomposePermissionSetBeta],
